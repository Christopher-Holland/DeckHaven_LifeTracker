...
import { MAX_PLAYERS, MIN_PLAYERS } from "@/lib/player-count";
...
export default function Setup() {
    ...
    const [gameSetup, setGameSetup] = useState<GameSetup>({
        ...
        minNumberOfPlayers: MIN_PLAYERS,
    ...
    const handleContinue = () => {
        setIsLoading(true);
        router.push(`/setup/players?count=${numberOfPlayers}`);
    };

    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 font-sans dark:bg-[#0f2a2c]">
            <div className="absolute top-4 left-4">
                <button type="button" className={iconButtonClass} onClick={() => router.back()}>
